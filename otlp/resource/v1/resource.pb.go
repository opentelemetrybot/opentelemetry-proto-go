...
func (x *Resource) GetEntities() []*ResourceEntityRef {
	if x != nil {
		return x.Entities
	}
	return nil
...
func (x *ResourceEntityRef) Reset() {
	*x = ResourceEntityRef{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opentelemetry_proto_resource_v1_resource_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ResourceEntityRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourceEntityRef) ProtoMessage() {}

func (x *ResourceEntityRef) ProtoReflect() protoreflect.Message {
	mi := &file_opentelemetry_proto_resource_v1_resource_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourceEntityRef.ProtoReflect.Descriptor instead.
func (*ResourceEntityRef) Descriptor() ([]byte, []int) {
	return file_opentelemetry_proto_resource_v1_resource_proto_rawDescGZIP(), []int{1}
}

func (x *ResourceEntityRef) GetSchemaUrl() string {
	if x != nil {
		return x.SchemaUrl
	}
	return ""
...
func (x *ResourceEntityRef) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ResourceEntityRef) GetIdAttrKeys() []string {
	if x != nil {
		return x.IdAttrKeys
	}
	return nil
...
func (x *ResourceEntityRef) GetDescrAttrKeys() []string {
	if x != nil {
		return x.DescrAttrKeys
	}
	return nil
}
...
var file_opentelemetry_proto_resource_v1_resource_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x4e, 0x0a,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79,
	0x52, 0x65, 0x66, 0x52, 0x08, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x22, 0x90, 0x01,
	0x0a, 0x11, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x0c, 0x69, 0x64, 0x5f, 0x61, 0x74, 0x74,
	0x72, 0x5f, 0x6b, 0x65, 0x79, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x69, 0x64,
	0x41, 0x74, 0x74, 0x72, 0x4b, 0x65, 0x79, 0x73, 0x12, 0x26, 0x0a, 0x0f, 0x64, 0x65, 0x73, 0x63,
	0x72, 0x5f, 0x61, 0x74, 0x74, 0x72, 0x5f, 0x6b, 0x65, 0x79, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x0d, 0x64, 0x65, 0x73, 0x63, 0x72, 0x41, 0x74, 0x74, 0x72, 0x4b, 0x65, 0x79, 0x73,
	0x42, 0x83, 0x01, 0x0a, 0x22, 0x69, 0x6f, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x74, 0x65, 0x6c, 0x65,
	...
	0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2a, 0x67, 0x6f, 0x2e, 0x6f, 0x70, 0x65,
	0x6e, 0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x2e, 0x69, 0x6f, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x6f, 0x74, 0x6c, 0x70, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
...
var file_opentelemetry_proto_resource_v1_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_opentelemetry_proto_resource_v1_resource_proto_goTypes = []interface{}{
	...
	(*ResourceEntityRef)(nil), // 1: opentelemetry.proto.resource.v1.ResourceEntityRef
...
var file_opentelemetry_proto_resource_v1_resource_proto_depIdxs = []int32{
	2, // 0: opentelemetry.proto.resource.v1.Resource.attributes:type_name -> opentelemetry.proto.common.v1.KeyValue
	1, // 1: opentelemetry.proto.resource.v1.Resource.entities:type_name -> opentelemetry.proto.resource.v1.ResourceEntityRef
...
func file_opentelemetry_proto_resource_v1_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_opentelemetry_proto_resource_v1_resource_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResourceEntityRef); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
